...
<div class="signinpanel">
    <div class="row">
      <div class="col-md-7">
        ...
        <div class="col-md-5">
            <form class="form-horizontal" id="submit_form" role="form" method="POST" action="{!! url('user/login') !!}">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div class="ckbox ckbox-default remember">
                    ...
                    <div class="col-md-6"><a href=""><small>Forgot Password?</small></a></div>         
                </div> 
                <button type="submit" class="btn btn-success btn-block">Sign In</button>
                <div style="float:left;">Not a member?</div><div><a href="">Sign Up</a></div>
            </form>
    </div>
    </div>
</div>
