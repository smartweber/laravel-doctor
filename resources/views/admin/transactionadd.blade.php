...
<div class="pageheader">
  <h2><i class="fa fa-user"></i> Add New Transactions <span></span></h2>
...
<div class="contentpanel"> 
  ...
  {!! Form::open(array('url' => 'admin/set_transaction', 'method' => 'post', 'class' => 'form-horizontal main-form', 'id' => 'transaction_form', 'autocomplete' => 'off' , 'enctype' => 'multipart/form-data')) !!}
        ...
        <div class="form-group" id="event_input" style="display:none;">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="text" id="beneficiary" name="beneficiary" placeholder="Required" class="form-control" />
              </div>
            </div>      
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type='text' class="form-control" id='transactiontype' placeholder="Required" name="transactiontype" />
              </div>
            </div>   
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="text" id="transactionvalue" name="transactionvalue" class="form-control" placeholder="Required" />
              </div>
            </div>      
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="text" id="datesent" name="datesent" class="form-control" />
              </div>
            </div>      
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type='text' class="form-control" id='datereceived' name="datereceived" />
              </div>
            </div>   
