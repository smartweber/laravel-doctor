...
<div class="contentpanel"> 
  ...
  @if (!is_null(Session::get('status_success')))
    ...
    @endif 
      ...
      {!! Form::open(array('url' => 'admin/edit_product', 'method' => 'post', 'class' => 'form-horizontal main-form', 'id' => 'product_form', 'autocomplete' => 'off' , 'enctype' => 'multipart/form-data')) !!}
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <input id="product_id" type="hidden" name="product_id" value="{!! $productid->id !!}">
        ...
        <div class="form-group" id="individual_input" style="display:none;">
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="text" id="name" name="name" placeholder="Required" class="form-control" value="{{$products->name}}" />
              </div>
            </div>      
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="text" id="identitycode" name="identitycode" class="form-control" value="{{$products->identitycode}}" />
              </div>
            </div>   
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <textarea rows="5" class="form-control" id="description" name="description" placeholder="Type your Description...">{{$products->description}}</textarea>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="text" id="productimage" name="productimage" class="form-control" value="{{$products->productimage}}" />
              </div>
            </div>  
        </div>
