...
<div class="pageheader">
  <h2><i class="fa fa-user"></i> Add New Task <span></span></h2>
...
<div class="contentpanel"> 
  ...
  {!! Form::open(array('url' => 'admin/set_task', 'method' => 'post', 'class' => 'form-horizontal main-form', 'id' => 'task_form', 'autocomplete' => 'off' , 'enctype' => 'multipart/form-data')) !!}
        ...
        <div class="form-group" id="task_input" style="display:none;">
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type='text' class="form-control" id='assignedto' placeholder="assignedto" name="assignedto" />
              </div>
            </div>   
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type='text' class="form-control" id='startdate' placeholder="Required" name="startdate" />
              </div>
            </div>   
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type='text' class="form-control" id='targetcompletiondate' placeholder="Required"  name="targetcompletiondate" />
              </div>
            </div>   
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="text" id="nexttask" name="nexttask" class="form-control" />
              </div>
            </div>      
        </div>
