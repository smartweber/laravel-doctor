...
<div class="pageheader">
  <h2><i class="fa fa-user"></i> Edit New Event <span></span></h2>
...
<div class="contentpanel"> 
  ...
  {!! Form::open(array('url' => 'admin/edit_event', 'method' => 'post', 'class' => 'form-horizontal main-form', 'id' => 'event_form', 'autocomplete' => 'off' , 'enctype' => 'multipart/form-data')) !!}
    <input type="hidden" name="_token" value="{{ csrf_token() }}">
    <input id="event_id" type="hidden" name="event_id" value="{!! $eventid->id !!}">
    <div class="panel-heading">
        ...
        <div class="form-group" id="event_input" style="display:none;">
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="text" id="name" name="name" placeholder="Required" class="form-control" value="{{$events->name}}" />
              </div>
            </div>      
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type='text' class="form-control" id='startdate' name="startdate" value="{{$events->startdate}}" />
              </div>
            </div>   
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <textarea rows="5" class="form-control" id="description" name="description" placeholder="Type your Description..."  >{{$events->description}}</textarea>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="text" id="enddate" name="enddate" placeholder="Required" class="form-control" value="{{$events->enddate}}" />
              </div>
            </div>             
        </div>
